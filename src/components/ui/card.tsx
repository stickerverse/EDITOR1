...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-xl border border-[rgba(255,255,255,0.10)] dark:bg-[rgba(40,40,40,0.70)] bg-gray-100 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group",
        className
      )}
    >
      {children}
...
export const CardSkeletonContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative rounded-xl z-40 overflow-hidden",
        className,
        showGradient &&
